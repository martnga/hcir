...
import org.mansa.hcir.adapter.CustomListAdapter;
...
public class MainActivity extends Activity {
    ...
    private List<WorldBillionaires> worldsBillionairesList = new ArrayList<WorldBillionaires>();
...
// Parsing json
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                WorldBillionaires worldsBillionaires = new WorldBillionaires();
